...
class SummarizationModel(object):
  ...
  #*********************************************************************************
  def _actualizar_attn_dists(self,attn_dists): #Funcion para unicar el nivel de atencion utilizando el resumen extractivo
    nivel_oracion=textrank.generar_puntuaciones()
     # obtenemos las puntuaciones del pagerank
    #print(attn_dists)
    temp=attn_dists
    for i in range(len(attn_dists)):
      for j in range(len(nivel_oracion)):
       temp[i]=(temp[i]*nivel_oracion[i][j])/ np.sum(temp*np.asarray(nivel_oracion[i]))#nivel de palabra actulizado
  ...
  def _calc_final_dist(self, vocab_dists, attn_dists):
    ...
    with tf.variable_scope('final_distribution'):
      ...
      temp=attn_dists
      #self._actualizar_attn_dists(temp)
