...
# Hyperparameters
tf.app.flags.DEFINE_integer('hidden_dim', 256, 'dimension of RNN hidden states')#256,50
tf.app.flags.DEFINE_integer('emb_dim', 128, 'dimension of word embeddings')#128,40
tf.app.flags.DEFINE_integer('batch_size', 16, 'minibatch size')#16 o 4 ,400,100 valores buenos 40,10
